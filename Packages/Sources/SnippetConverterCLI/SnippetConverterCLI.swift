...
struct SnippetConverter: ParsableCommand {
    ...
    @Argument(help: "The directory containing JSON files exported from Alfred, or an .alfredsnippets file.")
    ...
    private func validateInput() throws {
        ...
        case .directory, .zipFile:
            break
        case .unsupported:
            throw ValidationError("Invalid input: '\(snippetExportPath)'. Please provide a directory containing JSON files or an .alfredsnippets file.")
        }
    }
}
